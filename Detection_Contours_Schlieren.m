...
softbase = cd();
skip = 1; % Process toutes les x images (1 pour process toutes les images)
erosionsize=2;
...
%% MASQUE POUR LES ELECTRODES
    ...
    for i = num_image_deb:skip:TotalImage
        ...
        save([SaveContours '\Contour_' NomBrut(i,end-6:end-4)], 'Contour','Contour_filt','Contour_filt_int','Echelle_Filtre','Grandissement', 'num_image_deb', 'F', 'width', 'top', 'bot', 'electrodeheight');
